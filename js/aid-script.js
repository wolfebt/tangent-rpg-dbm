// Shared script for visual-aidv2.html and writer-aidv2.html

document.addEventListener('DOMContentLoaded', () => {

    // Logic for visual-aidv2.html
    ...
    // Logic for writer-aidv2.html
    if (document.title.includes("Writer AId v2")) {
        let userApiKey = '';
        const globalState = {
